...
$card = array(
			...
			'type' => 'text',
			'text' => 'ตัวอย่างการส่งข้อความภาพแบบ Rich Message ได้ฟรี โดยไม่ต้องลงทุนซื้อแพ็คเกจ ส่งได้ทั้งกระจายไปยังลูกค้าของคุณหรือส่งในกลุ่มก็ได้'
		      ]
			);
	...
	$card = array(
				...
				"template" => array(
				    'type' => 'buttons',
				    'text' => 'แน่นอนว่าฉันรู้จักคุณ และสามารถรู้จักลูกค้าของคุณได้อีกมากมาย สร้างความประทับใจในบริการ สามารถรู้ชื่อของคุณ ภาพโปรไฟล์ หรือแม้แต่สถานะที่คุณตั้งอยู่ตอนนี้ ลองให้ไลน์กรุ๊ปเรียกคุณดูสิ',
				    'actions' =>  array([
					  'type' => 'message',
