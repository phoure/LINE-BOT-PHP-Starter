...
if($last[0] == ''){
	...
	$text = 'รหัสติดตามพัสดุ '.$text_in.' ได้รับเรียบร้อยแล้ว '.$last[2].' '.$last[3].' เมื่อ '.$last[0];
}
else if($last[1] == 'เตรียมการนำจ่าย'){
	$text = 'รหัสติดตามพัสดุ '.$text_in.' กำลังเตรียมการนำจ่ายถึงผู้รับ ในพื้นที่ '.$last[3].' เมื่อ '.$last[0];
}
else{
	$text = 'รหัสติดตามพัสดุ '.$text_in.' '.$last[1].' โดย '.$last[3].' เมื่อ '.$last[0];
}
