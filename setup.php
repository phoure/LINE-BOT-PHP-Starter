...
if($userName == 'Methasit'){
	...
	$card2 = array(
		     [
		     'type' => 'text',
  			"text"=> '🎉 โพสต์โฆษณาแบบเต็มจอ! ลงบนกลุ่มธุรกิจ เพียงวันละ 4.-',
			],[
		     'type' => 'imagemap',
													    ...
													    'contents' =>  array([
																		...
																		,[
																			    ...
																			    'layout' => 'horizontal',
													  							...
													  							'contents' =>  array([
																									'type' => 'text',
																		          					"text" => 'โพสต์โฆษณาบนกลุ่มไลน์ให้เด่น สวย ปัง ขายดีกว่าใคร ไปยังกลุ่มไลน์ธุรกิจ คนเห็นหลักแสน ไม่ต้องหากลุ่มเอง',
																								'color' => '#ffffff',
	        																						"align" => "center",
																			   						'wrap' => true
																				]),
