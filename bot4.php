...
/*
	...
	*/
	...
	"altText" => '🎉 กำลังโพสต์ในกลุ่มคนเยอะๆ ที่มีแต่คนขายแต่ไม่มีคนซื้อ?',
						"template" => array(
						    'type' => 'buttons',
	'text' => '🎉 ลงทุนใหม่ให้ถูกจุด เห็นผลไว เพราะเราไม่เพียงทำโฆษณาบนกลุ่มผู้ขายเท่านั้น แต่เราเข้ายังถึงกลุ่มผู้ใช้งานทั่วไป กลุ่มคอมมิวนิตี้ต่างๆ ที่มีผู้ใช้งานจริง มีโฆษณาไม่แน่นจนเกินไป จึงทำได้เข้าถึงกลุ่มเป้าหมายได้อย่างดี',
						    'actions' =>  array([
						  'type' => 'uri',
						 'label' => 'สอบถามรายละเอียด',
						 'uri' => 'line://ti/p/%40gkw1117o'
