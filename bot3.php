	...
	curl_close($curl);
		 ...
		 $card = array([
				...
				'template' =>  array('type' => 'confirm',
						      'text' =>  'สวัสดี คุณ '.$arrJson['events'][0]['source']['displayName'].'\ nออร์เดอร์ของคุณหมายเลข #008888\ n- เค้กสตอวเบอร์รี่ 3 ปอนด์ 1 ชิ้น\ n-บราวนี่ช็อกโกแล็ต 3 ชิ้น\n- ชุดเทียนวันเกิด 1 ชุด \ n\ n โปรดยืนยันออร์เดอร์ทั้งหมดของคุณเพื่อที่เราจะได้ทำการจัดส่ง',
							    'actions' =>  array([
								    'type' => 'message',
